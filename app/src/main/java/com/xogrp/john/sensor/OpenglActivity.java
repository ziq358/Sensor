...
public class OpenglActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    public class MyRenderer implements GLSurfaceView.Renderer {
        ...
        private float[] cubeVertices = {-0.3f, -0.3f, -0.3f, -0.3f, 0.3f,
